...
governo.
	...
	\item Um dos passos para a concretização de
...
\begin{figure}
	...
	\item No início do projeto realizamos estudos de possíveis ferramentas que pudessem ser utilizadas para atender as necessidades do projeto, chegando então na lista apresentada abaixo.
 
	\begin{itemize}
	\item Lista de e-mail: Mailman;
	...
	\item Plataformas Forge: GitLab e Trac;
...
\begin{figure}
	  \begin{center}
	    \includegraphics[scale=0.7]{figures/visao_geral.jpg}
